...
def make_names_table(filtered_files: list[str], folder: str, ban_list: list[str]):
    ...
    for file in filtered_files:
        ...
        names = read_data_from_file(path, ban_list)
...
def main(folder: str) -> None:
    ...
    names_table = make_names_table(filtered_files, folder, ban_names)
