from encode_old_phone_messages import main, PHONE_INTERFACE


def check_exceptions(line: str, encode: bool):
    """Check for exceptions is PHONE_INTERFACE keys"""
    try:
...
test_decode = main(PHONE_INTERFACE, test_code, encode=False)
